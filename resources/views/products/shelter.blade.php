...
.emergency-info ul { margin-left: 20px; margin-top: 10px; color: #856404; }
.emergency-info li { margin-bottom: 5px; }
  ...
  <div class="container">
    ...
    <div class="facility-info">
      <div class="facility-details">
        <h2>Emergency Evacuation Shelter</h2>
        <p><strong>Primary Purpose:</strong> Designated safe area for calamity evacuation and emergency situations</p>
        <p><strong>Capacity:</strong> Can accommodate up to 600 evacuees</p>
        <p><strong>Location:</strong> Strategic elevated area safe from floods and other natural disasters</p>
        <p><strong>Emergency Activation:</strong> 24/7 during calamities and disasters</p>
        <p><strong>Emergency Contact:</strong> (123) 456-7899</p>
      </div>
    ...
    <h2 style="margin: 30px 0 20px 0; color: #1a1a2e;">Shelter Facilities</h2>
    
    <div class="features-grid">
      <div class="feature-card">
        <div class="feature-icon"><i class="fas fa-bed"></i></div>
        <div class="feature-title">Sleeping Areas</div>
        <div class="feature-description">Designated sleeping quarters with mats and bedding for evacuees</div>
        <span class="feature-status status-available">Available</span>
      </div>

      <div class="feature-card">
        <div class="feature-icon"><i class="fas fa-utensils"></i></div>
        <div class="feature-title">Food Distribution</div>
        <div class="feature-description">Meal preparation and distribution area with kitchen facilities</div>
        <span class="feature-status status-available">Available</span>
      </div>

      <div class="feature-card">
        <div class="feature-icon"><i class="fas fa-tint"></i></div>
        <div class="feature-title">Clean Water Supply</div>
        <div class="feature-description">Potable water supply and water purification system</div>
        <span class="feature-status status-available">Available</span>
      </div>

      <div class="feature-card">
        <div class="feature-icon"><i class="fas fa-restroom"></i></div>
        <div class="feature-title">Sanitation Facilities</div>
        <div class="feature-description">Clean restrooms and bathing facilities for evacuees</div>
        <span class="feature-status status-available">Available</span>
      </div>

      <div class="feature-card">
        <div class="feature-icon"><i class="fas fa-first-aid"></i></div>
        <div class="feature-title">Medical Station</div>
        <div class="feature-description">First aid station with basic medical supplies and personnel</div>
        <span class="feature-status status-available">Available</span>
      </div>

      <div class="feature-card">
        <div class="feature-icon"><i class="fas fa-plug"></i></div>
        <div class="feature-title">Power Generator</div>
        <div class="feature-description">Emergency power supply for essential equipment and lighting</div>
        <span class="feature-status status-available">Available</span>
      </div>

      <div class="feature-card">
        <div class="feature-icon"><i class="fas fa-broadcast-tower"></i></div>
        <div class="feature-title">Communication Center</div>
        <div class="feature-description">Communication equipment for coordination with emergency responders</div>
        <span class="feature-status status-available">Available</span>
      </div>

      <div class="feature-card">
        <div class="feature-icon"><i class="fas fa-warehouse"></i></div>
        <div class="feature-title">Supply Storage</div>
        <div class="feature-description">Stockpile of emergency supplies, food, and relief goods</div>
        <span class="feature-status status-available">Available</span>
      </div>
    </div>

    <div class="emergency-info">
      <h3><i class="fas fa-exclamation-triangle"></i> Emergency Evacuation Procedures</h3>
      <p><strong>When to Evacuate:</strong></p>
      <ul>
        <li>When evacuation alert is announced by barangay officials</li>
        <li>During typhoons, floods, earthquakes, or other natural disasters</li>
        <li>When your home becomes unsafe or uninhabitable</li>
      </ul>
      <p style="margin-top: 15px;"><strong>What to Bring:</strong></p>
      <ul>
        <li>Important documents (IDs, medical records, birth certificates)</li>
        <li>Emergency medicines and medical supplies</li>
        <li>Change of clothes and personal hygiene items</li>
        <li>Non-perishable food and drinking water</li>
        <li>Flashlights, batteries, and portable radio</li>
      </ul>
      <p style="margin-top: 15px;"><strong>Upon Arrival:</strong> Register at the reception desk for proper documentation and assistance. Follow the instructions of shelter coordinators and emergency personnel.</p>
    </div>
  </div>
</div>
